...
public class enterTag extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btn_addTag.setBackground(new java.awt.Color(0, 153, 204));
        btn_addTag.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn_addTag.setForeground(new java.awt.Color(255, 255, 255));
        btn_addTag.setText("Add");
        ...
        btn_editTag.setBackground(new java.awt.Color(255, 153, 0));
        btn_editTag.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn_editTag.setForeground(new java.awt.Color(255, 255, 255));
        ...
        add(btn_editTag, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 300, 160, 52));

        btn_deleteTag.setBackground(new java.awt.Color(255, 0, 0));
        btn_deleteTag.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn_deleteTag.setForeground(new java.awt.Color(255, 255, 255));
        ...
        add(btn_deleteTag, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 370, 164, 52));
